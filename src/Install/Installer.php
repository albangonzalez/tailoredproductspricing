    ...
    private function deregisterCustomizationFields(): bool
    {
        ...
        $softDeleted = $db->execute(
            'UPDATE `' . $prefix . 'customization_field` cf
             ...
             AND cf.`id_customization_field` IN (c.`id_customization_field_width`, c.`id_customization_field_height`, c.`id_customization_field_cord_side`, c.`id_customization_field_cassette`)'
        );
